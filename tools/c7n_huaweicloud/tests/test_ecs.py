...
class InstanceStartTest(BaseTest):
    ...
    def test_instance_query(self):
        ...
        p = self.load_policy(
            {'name': 'list_servers_details', 'resource': 'huaweicloud.ecs'}, session_factory=factory
        )
        resources = p.run()
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    {"type": "value", "key": "id", "value": "bac642b0-a9ca-4a13-b6b9-9e41b35905b6"}
                ],
        ...
        p = self.load_policy(
            {
                ...
                'resource': 'huaweicloud.ecs',
                'actions': [
                    {"type": "fetch-job-status", "job_id": "ff8080829585af7f0195c1e776d9475c"}
                ],
            },
            session_factory=factory,
        )
        ...
        p = self.load_policy(
            {
                ...
                'actions': [{"type": "instance-add-security-groups", "name": "sg-default-smb"}],
            },
            session_factory=factory,
        )
        resources = p.run()
        ...
        p = self.load_policy(
            {
                ...
                'actions': [{"type": "instance-delete-security-groups", "name": "sg-default-smb"}],
            },
            session_factory=factory,
        )
        resources = p.run()
        ...
        p = self.load_policy(
            {
                ...
                'actions': [
                    {"type": "instance-resize", "flavor_ref": "x1.1u.4g", "mode": "withStopServer"}
                ],
            },
            session_factory=factory,
        )
        ...
        p = self.load_policy(
            {
                ...
                'actions': [{"type": "set-instance-profile", "metadata": {"key": "value"}}],
            },
            session_factory=factory,
        )
        resources = p.run()
