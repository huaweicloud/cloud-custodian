...
class RDSTest(BaseTest):
    ...
    def test_rds_query(self):
        ...
        self.assertEqual(resources[0]['tags'],
                         [{'key': 'environment', 'value': 'testing'}])  # Assumed
    ...
    def test_rds_filter_value(self):
        ...
        # Assuming there is 1 active state instance
        self.assertEqual(len(resources_status), 1)
    ...
    def test_rds_filter_list_item(self):
        ...
        p = self.load_policy({
            ...
            session_factory=factory)
        resources = p.run()
        # Assuming there is 1 instance in the specified availability zone
    ...
    #         session_factory=factory)
    #     resources = p.run()
    # Assuming there is 1 instance with the specified tag
    #     self.assertEqual(len(resources), 1)
    ...
    def test_rds_action_start(self):
        ...
        p = self.load_policy({
            ...
            session_factory=factory)
        resources = p.run()
        # Assuming there is 1 instance in shutdown state
