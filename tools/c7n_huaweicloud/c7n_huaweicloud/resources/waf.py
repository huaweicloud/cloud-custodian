...
from huaweicloudsdkwaf.v1.model.update_lts_info_config_request_body import (
...
class WafPolicy(QueryResourceManager):
    ...
    class resource_type(TypeInfo):
        ...
        # Specify the API operation, result list key name,
        # and pagination parameters for enumerating resources
...
class UpdateLogConfig(HuaweiCloudBaseAction):
    ...
    This operation allows enabling/disabling WAF log configuration
    and setting log group and log stream information.
    ...
    def perform_action(self, resource):
        ...
        try:
            ...
            log.error(
                f"Failed to update WAF log configuration: "
