...
class NotProtectedByBackupSfsturbo(Filter):
    ...
    def process(self, resources, event=None):
        return [r for r in resources if self.is_sfsturbo_not_associated_to_vault(r)]
...
class SfsTurboAssociateToVaultPolicy(HuaweiCloudBaseAction):
    ...
    schema = type_schema("associate-sfsturbo-vault-to-policy", required=['policy_id'], policy_id={'type': 'string'})
