...
·
    ...
    def build_message(self, resources):
        ...
        self.log.warning(f"resource_details_fields:{resource_details_fields}")
        ...
        if empty_fields:
            for item in empty_fields:
                logging.warning(
                    f"[actions]-[notify-message] The resource:{resource_type} with id:{ids} "
                    f"The field value of the resource is empty, id: {item['id']}, field: {item['field']}")
        ...
        if empty_fields:
            for item in empty_fields:
                logging.warning(
                    f"[actions]-[notify-message-structure] The resource:{resource_type} with id:{ids} "
                    f"The field value of the resource is empty, id: {item['id']}, field: {item['field']}")
        return message_structure.replace('{resource_details}', resource_details_str)
